...
from scrapapp.forms import RegistrationForm,LoginForm,UserProfileForm,ScrapForm,BidsForm
from django.contrib.auth import authenticate,login,logout
from django.http import HttpResponseRedirect
from scrapapp.models import Scraps,UserProfile,Bids,Category,WishList
...
@method_decorator(signin_required,name="dispatch")
class WishlistView(View):#shopping cart
